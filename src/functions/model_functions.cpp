...
void RegisterModelFunctions(ExtensionLoader &loader) {
    ...
    auto download_func = ScalarFunction("whisper_download_model", {LogicalType::VARCHAR},
                                         LogicalType::VARCHAR, WhisperDownloadModelFunction);
    loader.RegisterFunction(download_func);

    // whisper_delete_model(model_name)
    auto delete_func = ScalarFunction("whisper_delete_model", {LogicalType::VARCHAR},
                                       LogicalType::VARCHAR, WhisperDeleteModelFunction);
