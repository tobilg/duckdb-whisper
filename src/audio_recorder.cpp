...
AudioRecorder::AudioRecorder()
    : device_id_(0), recording_(false), sample_rate_(16000),
      current_amplitude_(0.0f), silence_threshold_(0.01f),
      silence_duration_sec_(0.0), silence_start_time_(0.0),
...
bool AudioRecorder::RecordUntilSilence(std::vector<float> &pcm_data,
                                        double max_duration_sec,
                                        double silence_duration_sec,
